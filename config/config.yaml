...
# ===============================================================
ai_analysis:
  enabled: true                     # 是否启用 AI 分析（true=启用, false=关闭）—— 总开关
...
# ===============================================================
ai_translation:
  enabled: true                     # 是否启用翻译功能（true=启用, false=关闭）
